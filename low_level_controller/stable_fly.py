...
def parse_args():
    ...
    parser.add_argument('--lr', type=float, default=2e-4, help='Learning rate for optimizers (must be positive)')
    parser.add_argument('--alpha', type=float, default=0.5, help='Entropy coefficient for SAC (must be non-negative)')
